...
export function MapCard({ product }: MapCardProps) {
  ...
  <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-[1.03] hover:-translate-y-1">
      {badgeText && (
        <Badge className="absolute top-4 right-4 z-10 bg-gradient-to-r from-green-600 via-green-500 to-green-600 hover:from-green-700 hover:via-green-600 hover:to-green-700 transition-all duration-200 animate-pulse shadow-[0_0_20px_rgba(34,197,94,0.8)] border-2 border-green-300">
