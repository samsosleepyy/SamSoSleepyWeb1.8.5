...
export function McUiCard({ product }: McUiCardProps) {
  ...
  <Card className="relative overflow-hidden transition-all duration-300 hover:shadow-xl hover:scale-[1.03] hover:-translate-y-1">
      {badgeText && (
        <Badge className="absolute top-4 right-4 z-10 bg-gradient-to-r from-purple-600 via-purple-500 to-purple-600 hover:from-purple-700 hover:via-purple-600 hover:to-purple-700 transition-all duration-200 animate-pulse shadow-[0_0_20px_rgba(168,85,247,0.8)] border-2 border-purple-300">
